      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="font-bold text-gradient-cyan font-sans text-4xl">
              Gloriae Musica
            </span>
          </Link>
          ...
          <div className="flex items-center gap-6">
            ...
            {user ? <>
                ...
                <Button variant="ghost" onClick={signOut} className="gap-2 text-foreground hover:text-destructive transition-colors">
