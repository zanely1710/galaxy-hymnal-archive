    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-blue-50">
      ...
      <main className="flex flex-col items-center justify-center min-h-screen px-4 pt-20">
        <div className="text-center space-y-8 max-w-4xl mx-auto animate-fade-in">
          ...
          <h1 className="text-6xl font-bold text-gradient-animated leading-tight font-sans md:text-9xl">
            Gloriae Musica
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            <Link to="/archive">
              <Button
                size="lg"
                className="gap-2 text-lg px-8 py-6 glow-blue hover:scale-105 transition-transform"
              >
            ...
            <Link to="/auth">
              <Button
                size="lg"
                variant="outline"
                className="gap-2 text-lg px-8 py-6 border-primary hover:bg-primary hover:text-primary-foreground transition-all"
              >
          ...
          <div
            ref={featuresRef}
            className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-16 max-w-3xl mx-auto"
          >
            {[
              {
                title: "Free Access",
              ...
              <div
                key={i}
                className="glass-card p-6 rounded-lg hover:scale-105 transition-all glow-blue scroll-fade-in"
